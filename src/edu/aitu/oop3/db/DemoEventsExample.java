...
public class DemoEventsExample {
    public static void main(String[] args) {
        ...
        try (Connection connection = DatabaseConnection.getConnection()) {
            ...
            insertUser(connection, "Alice", "alice@astanait.edu.kz");
            insertUser(connection, "Bob", "bob@astanait.edu.kz");
...
private static void printAllUsers(Connection connection) throws SQLException {
        ...
        try (PreparedStatement stmt = connection.prepareStatement(sql);
            ...
            while (rs.next()) {
                ...
                System.out.printf(" %d | %%n", id, name, email);
            }
    }
}
}
